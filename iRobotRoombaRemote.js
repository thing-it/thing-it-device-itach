module.exports = {
    metadata: itach.createMetadata({family: "iRobotRoombaRemote", plugin: "iRobotRoombaRemote",
        label: "iRobot Roomba Remote"}, commands),
    create: function () {
        return itach.create(commands);
    }
};

var itach = require("thing-it-device-itach/lib/itach");
var commands = {
    "start": "sendir,1:1,1,37735,1,1,171,171,21,64BB,21,21CCCCBBBCCCCCCBCCCCCCBCBBBBBB,21,3773",
